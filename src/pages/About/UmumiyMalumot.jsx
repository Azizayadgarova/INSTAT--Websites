...
const HuquqiyAsos = () => {
	...
	<section style={{ maxWidth: '980px', marginTop: '40px' }}>
		...
		>
			{t('pages.umumiyMalumot.huquqiy_asos', 'Huquqiy asos')}
		</h2>
		<ul style={{ listStyle: 'disc', paddingLeft: '20px', margin: 0 }}>
			{HUQUQIY_ASOS_KEYS.map(({ key, fallback }, i) => (
				<li
					key={i}
					style={{
						marginBottom: '12px',
