...
const HeroZoom = () => {
  ...
  useEffect(() => {
    ...
    const ctx = gsap.context(() => {
      ...
      // Rasm to'liq ekran kengligini egallaydi (100%)
      // screen-box = wrapper ning 98% → initialScale = vw / (0.82 * wrapperW)
      // Shunda screen-box aynan 100% vw bo'ladi, telefon ramkasi esa
      // har ikki yondan ~2% chiqib turadi va scroll bilan birga sekin ko'rinadi
      ...
      const tl = gsap.timeline({
        scrollTrigger: {
          ...
          onRefresh: self => {
            ...
            if (w) gsap.set(zoomWrapperRef.current, { scale: window.innerWidth / (w * 0.82) })
          },
        },
      })
      ...
      tl.fromTo(
        ...
        // borderRadius tez — zoom boshlanishi bilan darhol yumaloqladi
        .fromTo(
          screenElement,
          { borderRadius: '0rem' },
        ...
        // Telefon ramkasi tez — zoom boshida darhol ichidan chiqib keladi
        .fromTo(
  ...
  return (
    <section
      ref={containerRef}
      className='relative w-full mt-[100px] h-screen bg-[rgba(14,18,27,1)] flex items-center justify-center overflow-y-hidden z-[50]'
